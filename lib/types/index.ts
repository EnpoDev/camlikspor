...
export const Permission = {
  ...
  SUB_DEALERS_CREATE: "SUB_DEALERS_CREATE",
  SUB_DEALERS_EDIT: "SUB_DEALERS_EDIT",
  SUB_DEALERS_DELETE: "SUB_DEALERS_DELETE",
  ...
  // Sponsors
  SPONSORS_VIEW: "SPONSORS_VIEW",
  SPONSORS_CREATE: "SPONSORS_CREATE",
  SPONSORS_EDIT: "SPONSORS_EDIT",
  SPONSORS_DELETE: "SPONSORS_DELETE",

  // Tactical Board
  TACTICAL_BOARD_VIEW: "TACTICAL_BOARD_VIEW",
  TACTICAL_BOARD_CREATE: "TACTICAL_BOARD_CREATE",
  TACTICAL_BOARD_EDIT: "TACTICAL_BOARD_EDIT",
  TACTICAL_BOARD_DELETE: "TACTICAL_BOARD_DELETE",
  ...
  // Student Development
  STUDENT_DEVELOPMENT_VIEW: "STUDENT_DEVELOPMENT_VIEW",
  STUDENT_DEVELOPMENT_CREATE: "STUDENT_DEVELOPMENT_CREATE",
  STUDENT_DEVELOPMENT_EDIT: "STUDENT_DEVELOPMENT_EDIT",
  STUDENT_DEVELOPMENT_DELETE: "STUDENT_DEVELOPMENT_DELETE",

  // Body Measurements
  BODY_MEASUREMENTS_VIEW: "BODY_MEASUREMENTS_VIEW",
  BODY_MEASUREMENTS_CREATE: "BODY_MEASUREMENTS_CREATE",
  BODY_MEASUREMENTS_EDIT: "BODY_MEASUREMENTS_EDIT",
  BODY_MEASUREMENTS_DELETE: "BODY_MEASUREMENTS_DELETE",
  ...
  // Expense Items
  EXPENSE_ITEMS_VIEW: "EXPENSE_ITEMS_VIEW",
  EXPENSE_ITEMS_CREATE: "EXPENSE_ITEMS_CREATE",
  EXPENSE_ITEMS_EDIT: "EXPENSE_ITEMS_EDIT",
  EXPENSE_ITEMS_DELETE: "EXPENSE_ITEMS_DELETE",
  ...
  // Income Items
  INCOME_ITEMS_VIEW: "INCOME_ITEMS_VIEW",
  INCOME_ITEMS_CREATE: "INCOME_ITEMS_CREATE",
  INCOME_ITEMS_EDIT: "INCOME_ITEMS_EDIT",
  INCOME_ITEMS_DELETE: "INCOME_ITEMS_DELETE",

  // Incomes
  INCOMES_VIEW: "INCOMES_VIEW",
  INCOMES_CREATE: "INCOMES_CREATE",
  INCOMES_EDIT: "INCOMES_EDIT",
  INCOMES_DELETE: "INCOMES_DELETE",

  // Job/Task Definitions
  TASK_DEFINITIONS_VIEW: "TASK_DEFINITIONS_VIEW",
  TASK_DEFINITIONS_CREATE: "TASK_DEFINITIONS_CREATE",
  TASK_DEFINITIONS_EDIT: "TASK_DEFINITIONS_EDIT",
  TASK_DEFINITIONS_DELETE: "TASK_DEFINITIONS_DELETE",

  // Other Payment Types
  OTHER_PAYMENT_TYPES_VIEW: "OTHER_PAYMENT_TYPES_VIEW",
  OTHER_PAYMENT_TYPES_CREATE: "OTHER_PAYMENT_TYPES_CREATE",
  OTHER_PAYMENT_TYPES_EDIT: "OTHER_PAYMENT_TYPES_EDIT",
  OTHER_PAYMENT_TYPES_DELETE: "OTHER_PAYMENT_TYPES_DELETE",

  // Dues/Membership Fee Types
  DUES_TYPES_VIEW: "DUES_TYPES_VIEW",
  DUES_TYPES_CREATE: "DUES_TYPES_CREATE",
  DUES_TYPES_EDIT: "DUES_TYPES_EDIT",
  DUES_TYPES_DELETE: "DUES_TYPES_DELETE",
} as const;
