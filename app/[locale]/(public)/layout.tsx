          ...
          <div className="flex min-h-screen flex-col">
            <PublicHeader
              ...
              dictionary={{
                ...
                training: publicDict.training || "Eğitimler",
                maleFootball: publicDict.maleFootball || "Erkek Futbol",
                femaleFootball: publicDict.femaleFootball || "Kız Futbol",
                futsal: publicDict.futsal || "Futsal",
                esports: publicDict.esports || "E-Spor",
