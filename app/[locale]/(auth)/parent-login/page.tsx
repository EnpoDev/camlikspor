        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
          ...
          <div className="space-y-4 w-full max-w-sm">
            <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/10">
              ...
              <div>
                <p className="font-black uppercase tracking-wide text-sm">Ders Programi</p>
                <p className="text-sm text-white/60">Cocugunuzun antrenman saatlerini gorun</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/10">
              ...
              <div>
                <p className="font-black uppercase tracking-wide text-sm">Devamsizlik Takibi</p>
                <p className="text-sm text-white/60">Katilim durumunu anlik takip edin</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/10">
              ...
              <div>
                <p className="font-black uppercase tracking-wide text-sm">Aidat Yonetimi</p>
                <p className="text-sm text-white/60">Odemelerinizi kolay ve guvenle yapin</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-slate-900">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-black uppercase tracking-wide text-white">Veli Paneli</h1>
          </div>
