...
const iconMap: Record<string, React.ElementType> = {
  ...
  personnel: Briefcase,
  "expense-items": TrendingDown,
  "income-items": TrendingUp,
  expenses: TrendingDown,
  incomes: TrendingUp,
  "task-definitions": ListChecks,
  "other-payment-types": Wallet,
  "dues-types": DollarSign,
  payments: Banknote,
  "cash-register": Wallet,
  "daily-status": Calculator,
  "online-payments": DollarSign,
};
